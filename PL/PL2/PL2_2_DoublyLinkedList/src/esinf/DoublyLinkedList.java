...
// private update methods
    ...
    private void addBetween(E e, Node<E> predecessor, Node<E> successor) {
        Node<E> element = new Node<E>(e, predecessor, successor);
...
// Overriden methods        
    ...
    public boolean equals(Object obj) {
        ...
        DoublyLinkedList<E> doublll = (DoublyLinkedList<E>) obj;
        if (doublll.size != this.size()) {
            return false;
        }
        boolean res = true;
        Iterator<E> it = this.iterator();
        Iterator<E> it2 = doublll.iterator();
    ...
    public Object clone() throws CloneNotSupportedException {
        DoublyLinkedList<E> doublll = new DoublyLinkedList<>();
        Iterator<E> it = this.iterator();
        while (it.hasNext()) {
            doublll.addLast(it.next());
        }
        return doublll;
    }
